// Gestionnaire de traductions pour CityLoop Quest Gand
class TranslationManager {
    ...
    translate(key) {
        ...
        const langAliases = { jp: 'ja', ja: 'jp', zh: 'cn', cn: 'zh' };
    ...
    async init() {
        ...
        if (typeof window.applyCulturePageI18n === 'function') {
            window.applyCulturePageI18n();
        }
