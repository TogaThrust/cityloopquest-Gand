/**
 * Réécrit les descriptions POI Gand en textes visiteurs, sans formulation interne.
 * Usage: node scripts/rewrite-gand-poi-descriptions.mjs
 */
import fs from "fs";
